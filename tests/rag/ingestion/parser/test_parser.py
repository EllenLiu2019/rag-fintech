...
from rag.ingestion.parser.parser import ContentParser
...
class TestContentParser:
    ...
    def test_extract_with_content_type(self):
        ...
        documents = parser.parse(b"content", "test.unknown", content_type="application/mock")
    ...
    def test_extract_logging(self):
        ...
        with patch("rag.ingestion.parser.parser.logger") as mock_logger:
            parser.parse(b"content", "test.mock")
